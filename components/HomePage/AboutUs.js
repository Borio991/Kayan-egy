      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col items-start justify-center md:flex-row">
          <div className="flex-1 md:mt-10">
            <div>
              <p className="mx-4 w-5/6 leading-8">
                <span className="gradientText font-bold md:text-xl lg:text-2xl">
                  {en ? 'Kayan Develpments' : 'كيان للتطوير العقاري'}
                </span>{' '}
                {en
          ...
          <div className="mx-4 mt-8 flex flex-1 flex-col justify-center">
            <AchievmentItem
              icon={<BsFillBookmarkCheckFill fill="#ff5f3c" size={36} />}
              number="12 +"
              text={en ? 'Years in Business' : 'سنوات في العمل'}
            />
            <AchievmentItem
              icon={<FaMedal fill="#ff5f3c" size={36} />}
              number="1600 +"
              text={en ? 'Project Finished' : 'عدد المشاريع المنجزة'}
            />
            <AchievmentItem
              icon={<FaSmileBeam fill="#ff5f3c" size={36} />}
              number="210 +"
